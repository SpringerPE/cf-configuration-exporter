...
class TestExporter(unittest.TestCase):
	...
	def test_security_rule(self):
		...
		sec_rule.load()
		self.assertEquals(sec_rule.sec_rule['protocol'], 'udp')
		self.assertEquals(sec_rule.sec_rule['ports'], '8080')
		self.assertEquals(sec_rule.sec_rule['destination'], '198.41.191.47/1')